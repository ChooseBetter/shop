<template>
  ...
  <div class="g-service">
    ...
    <dl>
      ...
      <dd>
        至
        <XtxCity @changeAddress="changeAddress" :fullLocation="fullLocation" />
      </dd>
    </dl>
    <dl>
      <dt>服务</dt>
...
import {AddressResultType} from "@/components/library/types";
...
//地址选择处理
const changeAddress = (result: AddressResultType) => {
